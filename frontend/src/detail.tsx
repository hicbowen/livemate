...
function SessionsTab({ anchorId, sessions, onCreate, onEdit, onCreateReview, onDelete }: { anchorId: number; sessions: LiveSession[]; onCreate: () => void; onEdit: (session: LiveSession) => void; onCreateReview: (sessionId: number) => void; onDelete: (id: number) => void }) {
